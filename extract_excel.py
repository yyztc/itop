...
class ExtractExcel():
    ...
    def extract_physical_server(self):
        ...
        excel_ps_df = pd.DataFrame(pd.read_excel('cs_hw.xlsx', 'Physical Server')).rename(columns=str.lower). rename(columns=ps_map_dict).drop(
    ...
    def extract_storage(self):
        ...
        excel_st_json = pd.DataFrame(pd.read_excel('cs_hw.xlsx', 'Storage related')).rename(
    ...
    def extract_network(self):
        ...
        excel_network_json = pd.DataFrame(pd.read_excel('cs_hw.xlsx', 'Network & KVM SW & UPS')).rename(
